...
class PDF(FPDF):
    ...
    def pre_authenticated(self, company_name,sign):
        ...
        try:
            self.image("/home/ubuntu/bill-system/bill/billing/"+sign, x = 83, y = 265, w = 49, h = 7, type = 'JPG', link = '')
        except:
            pass
        self.set_xy(80,274)
        self.set_font('Arial', '', 10)
    ...
    def signatory(self, company_name,sign):
        ...
        try:
            self.image("/home/ubuntu/bill-system/bill/billing/" + sign, x = 140, y = 265, w = 49, h = 7, type = 'JPG', link = '')
        except:
            pass
        self.set_xy(135,274)
        self.set_font('Arial', '', 10)
