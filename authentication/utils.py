...
class PDF(FPDF):
    ...
    def billed_to(self, bill_to):
        ...
        self.set_xy(35,100)
        self.set_font('Arial', '', 12)
        self.cell(70,6,bill_to.name.upper(), 0, 0,'L')
        self.set_xy(15,106)
        self.set_font('Arial', 'B', 12)
        self.cell(20,6,"Address :", 0, 0,'L')
        self.set_xy(35,106)
        self.set_font('Arial', '', 12)
        self.cell(70,6,bill_to.address.title(), 0, 0,'L')
        self.set_xy(15,118)
        self.set_font('Arial', 'B', 12)
    ...
    def shipped_to(self, bill_to):
        ...
        self.set_xy(125,124)
        self.set_font('Arial', '', 12)
        self.cell(70,6,bill_to.gstin.upper(), 0, 0,'L')
        self.set_thead()
    ...
    def bill_items(self, bill_items):
        ...
        self.set_font('Arial', '', 12)
        self.set_xy(170, 195)
        self.cell(25,8,str(total_amt), 0, 1,'R')
